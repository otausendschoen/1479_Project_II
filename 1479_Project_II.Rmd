...
for (k in 2:maxtops){
 ...
 plot(fitted_LDA@logLiks,type="l", main=paste0(c("kindle",k),collapse=""))
...
avg_result_fin
```
To take a final decision about the number of plots it can be helpful to plot the AIC values for different numbers of topics. We want to minimize AIC and thus choose only 1 topic 
