...
This supports our hypothesis that the vast majority of reviews are rated as non-helpful by very few to none people. Only very few people attained over 15 "helpfulness"-votes. We can see the "Winner takes it all" principle.
...
To kick off our text analysis, we start by taking a look at review length. We can see that the average length of a review in our dataset is about 70 word. But what might be more interesting is the **correlation between the length of a reviews and its rating.
...
**correlation between the length of a review and its helpfulness
The correlation is at about 0.63 This leads to the conclusion that longer reviews tend to be rated as more helpful as they for example share more information and details that can be useful for other potential customers. 
